            ...
            <div className='container'>
                <div className='flex justify-between items-center'>
                    <div className='flex items-center'>
                        ...
                        <h6 className='hidden md:block text-3xl text-main-color'>FXL'S Residence</h6>
                    </div>
                    ...
                    <div className='hidden md:flex justify-center text-main-color'>
                        <a href="https://web.facebook.com/fay.call.31" target='__blanc'><AiFillFacebook className='text-xl mr-2 hover:text-[#3b5998]' /></a>
                        <a href="https://www.instagram.com/b.faycal_8/" target='__blanc'><AiOutlineInstagram className='text-xl mr-2 hover:text-[#cd486b]' /></a>
                        <a href="https://twitter.com/BFaycal8?s=09" target='__blanc'><AiFillTwitterSquare className='text-xl hover:transition-all hover:text-[#1DA1F2]' /></a>
                    </div>
                    <div>
                        <div>
                            ...
                            <div>
                                <div className={ nav ? 'hidden absolute' : 'md:hidden flex flex-col absolute right-1/2 translate-x-1/2 text-center'}>
                                    <div className='flex flex-col items-center mb-4'>
                                        <h6 className='text-2xl'>FXL Residence</h6>
                                    ...
                                    <div className='flex justify-center my-4'>
                                        <a href="https://web.facebook.com/fay.call.31" target='__blanc'><AiFillFacebook className='text-xl mr-2 duration-200 hover:text-[#3b5998]' /></a>
                                        <a href="https://www.instagram.com/b.faycal_8/" target='__blanc'><AiOutlineInstagram className='text-xl mr-2 duration-200 hover:text-[#cd486b]' /></a>
                                        <a href="https://twitter.com/BFaycal8?s=09" target='__blanc'><AiFillTwitterSquare className='text-xl hover:text-[#1DA1F2]' /></a>
                                    </div>
                                    <div>
