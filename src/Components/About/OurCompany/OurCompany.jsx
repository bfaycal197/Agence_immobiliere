                ...
                <div className="container">
                    <div className='flex flex-col justify-between items-center sm:flex-row'>
                        ...
                        <div className='sm:w-[60%] mt-12 sm:mt-0 sm:ml-16'>
                            <h5 className='relative mb-4 text-xl w-fit left-12 before:absolute before:top-1/2 before:right-[103%] before:-translate-y-1/2 before:w-[20%] before:bg-second-color before:h-[2px]'>About Fayçal's Residence</h5>
